...
namespace Dev.App.Extensions
{
    ...
    public class ClaimsAuthirizeAttribute : TypeFilterAttribute
    {
        public ClaimsAuthirizeAttribute(string claimName, string claimValue) : base(typeof(RequisitoClaimFilter))
        {
